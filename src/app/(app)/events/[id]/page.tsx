  ...
  return (
    <>
      <div className="max-lg:hidden">
        <Link href="/events" className="inline-flex items-center gap-2 text-sm/6 text-zinc-500 dark:text-amber-400">
          <ChevronLeftIcon className="size-4 fill-zinc-400 dark:fill-amber-400" />
          Events
        </Link>
      </div>
